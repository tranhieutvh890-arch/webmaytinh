...
<head>
  ...
  <title>laptop4study.com.vn — Máy cũ, Thu cũ</title>
  ...
  <main class="container">
    <section class="section">
      <div class="section__head">
        <h2>Máy cũ, Thu cũ</h2>
        <a href="<c:url value='/page/maycu'/>" class="link">Xem tất cả</a>
      </div>
...
<%-- ✅ SẢN PHẨM LẤY TỪ DATABASE --%>
        <c:if test="${not empty products}">
          <c:forEach var="p" items="${products}">
            ...
            <c:if test="${p.maDanhMuc == 6}"><%-- 1 = Laptop trong bảng DanhMuc --%>
        ...
        <!-- Thêm sản phẩm máy cũ khác tại đây -->
      </div>
    </section>
  </main>
