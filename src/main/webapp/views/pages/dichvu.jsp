  ...
  <main class="container">
    <section class="section">
      <div class="section__head">
        <h2>Dá»‹ch vá»¥ tiá»‡n Ã­ch</h2>
        <a href="<c:url value='/page/dichvu'/>" class="link">Xem táº¥t cáº£</a>
      </div>

      
      <div class="grid">
        <article class="card">
          <h3 class="card__title">Vá»‡ sinh laptop</h3>
          <p>Vá»‡ sinh â€“ thay keo táº£n nhiá»‡t chuyÃªn nghiá»‡p.</p>
        </article>
        <article class="card">
          <h3 class="card__title">CÃ i Ä‘áº·t pháº§n má»m</h3>
          <p>CÃ i Windows â€“ Office â€“ driver chuáº©n mÃ¡y.</p>
        </article>
      </div>
    </section>
  </main>
