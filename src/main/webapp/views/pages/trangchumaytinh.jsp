...
<div class="header">
  ...
  <main class="container">
    ...
    <section class="section">
      <div class="section__head">
        <h2>PC</h2>
        <a href="<c:url value='/page/pc'/>" class="link">Xem táº¥t cáº£</a>
      </div>
    ...
    <section class="section">
      <div class="section__head">
        <h2>MÃ n hÃ¬nh</h2>
        <a href="<c:url value='/page/manhinh'/>" class="link">Xem táº¥t cáº£</a>
      </div>
    ...
    <section class="section">
      <div class="section__head">
        <h2>Tablet</h2>
        <a href="<c:url value='/page/phukien'/>" class="link">Xem táº¥t cáº£</a>
      </div>
