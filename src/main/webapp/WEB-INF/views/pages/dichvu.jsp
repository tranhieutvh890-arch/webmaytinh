  ...
  <main class="container">
    <section class="section">
      <div class="section__head">
        ...
        <a href="<c:url value='/page/dichvu'/>" class="link">Xem tất cả</a>
      </div>

      <!-- Nội dung dịch vụ: thêm các block dịch vụ tại đây -->
      <div class="grid">
        <article class="card">
          <h3 class="card__title">Vệ sinh laptop</h3>
          <p>Vệ sinh – thay keo tản nhiệt chuyên nghiệp.</p>
        </article>
        <article class="card">
          <h3 class="card__title">Cài đặt phần mềm</h3>
          <p>Cài Windows – Office – driver chuẩn máy.</p>
        </article>
      </div>
    </section>
  </main>
