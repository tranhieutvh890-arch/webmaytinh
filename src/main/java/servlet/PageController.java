...
public class PageController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        // =============================
        // 🔐 Nếu là ADMIN và truy cập /home -> chuyển sang trang quản trị
        // =============================
        ...
        try {
            ...
            if ("chitietsanpham".equals(name)) {
                ...
                if (idParam == null || idParam.isBlank()) {
                    resp.sendError(HttpServletResponse.SC_BAD_REQUEST, "Thiếu id sản phẩm");
                    return;
                }
            ...
            // =============================
            // 📦 Load danh sách sản phẩm cho các trang list
            // =============================
            ...
            throw new ServletException("Lỗi khi load dữ liệu: " + e.getMessage(), e);
        }
